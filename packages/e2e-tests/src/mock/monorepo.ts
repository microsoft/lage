...
export class Monorepo {
  ...
  constructor(private name: string, private yarnVersion: 1 | 3 = 1) {
  ...
  linkPackages() {
    ...
    let yarnYaml = this.yarnVersion === 1 ? `# THIS IS AN AUTOGENERATED FILE. DO NOT EDIT THIS FILE DIRECTLY.\n# yarn lockfile v1\n` : `# This file is generated by running "yarn install" inside your project.\n# Manual changes might be lost - proceed with caution!\n\n__metadata:\n  version: 6\n  cacheKey: 8\n\n`;
    ...
    for (const pkg of pkgs) {
      ...
      if (this.yarnVersion === 1) {
        ...
        yarnYaml += `"${pkg}@^${pkgJson.version}, ${pkg}@workspace:packages/${pkg}":\n  version 0.0.0-use.local\n  resolution: "${pkg}@workspace:packages/${pkg}"\n`;
