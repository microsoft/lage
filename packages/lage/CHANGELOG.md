...
- `lage`
  - Generate the CLI bundles directly from TypeScript code, not from the intermediate CJS generated by swc. This is marked as a minor change due to slight chance of behavior differences. (elcraig@microsoft.com)
...
- `lage`
  ...
  - Update nested dependencies (elcraig@microsoft.com)
