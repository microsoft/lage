    ...
    <div className="theme-color bg-black py-8">
      <TwoColumns>
        ...
        <div>
          ...
          <p className={styles.fullLengthPara}>There’s no better time than now to save yourself time. Get started within a minute with a single command! </p>
          <p className="font-bahnschrift text-primary text-center whitespace-pre-wrap mx-12 mb-4 w-36 bg-body-2 text-2xl"> npx lage init </p>
          <SideBySide>
