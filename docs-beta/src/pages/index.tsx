      ...
      <main className="theme-dark bg-primary">
        <TwoColumns>
          <div className="text-left">
            <h1 className={styles.point}>
              Finally! Your days of <br />
              suffering are over
            </h1>
            <p className={styles.para}>
              Explain the problem that Lage solves here. No jargon! Lorem ipsum
              ...
              urna nibh, viverra. Lorem ipsum dolor sit amet, consectetuer
              adipiscing elit. Donec odio quisco.
            </p>
            <Tweet
              toLeft={true}
        ...
        <TwoColumns className="mt-16">
          ...
          <div className="text-right justify-end">
            ...
            <p className={styles.para}>
              Show off the absolute BEST benefit of Lage. Does it make your life
              easier? Will you be more popular? Most handsome person alive? Tap
              into that empathy and ask yourself, how will this make my customer
              FEEL? Address that! Don’t worry about the 2nd and 3rd benefits.
              We’ll get there. Lorem ipsum dolor sit amet, consectetuer
        ...
        <p className={styles.para}>
          Monorepos are beautiful. That's all we need to know. Could I BE loving
          monorepos more? Monorepos are beautiful. That's all we need to know.
          Could I BE loving monorepos more? Monorepos are beautiful. That's all
          we need to know. Could I BE loving monorepos more? Monorepos are
          beautiful. That's all we need to know. Could I BE loving monorepos
          more? Monorepos are beautiful. That's all we need to know. Could I BE
          loving monorepos more?{" "}
        </p>
