  ...
  return (
    <div className="text--center padding-horiz--md">
      <div className="my-3 p-6 max-w-sm bg-white rounded-lg border border-tertiary">
        ...
        <a
          href={link}
          className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-secondary bg-brand rounded-lg hover:bg-accent hover:text-secondary hover:no-underline focus:ring-4"
        >
          Read more
