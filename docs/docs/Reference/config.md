...
module.exports = {
  pipeline: {
    babel: {
       ...
       * 
       * This uses the 'glob' package from npm, refer that package's documentation
       * for the full glob syntax:
       * 
       * https://github.com/isaacs/node-glob#readme
       * 
       * Relative paths will be relative to the package directory, you can calculate
       * absolute paths relative to the config file using path.join(__dirname, ...).
       */
