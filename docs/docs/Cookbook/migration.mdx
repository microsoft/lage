...
4. `WorkerRunner` to help make tools line lint or TypeScript run super fast by reusing context in a [dedicated worker](./make-lint-fast.mdx) (e.g. ESLint instance, TypeScript program)
